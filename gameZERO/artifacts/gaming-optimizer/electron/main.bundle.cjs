...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/package.json"(exports2, module2) {
    module2.exports = {
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/util.js
var require_util = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/util.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var fs2 = require("fs");
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/osinfo.js
var require_osinfo = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/osinfo.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var fs2 = require("fs");
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/system.js
var require_system = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/system.js"(exports2) {
    "use strict";
    var fs2 = require("fs");
    var os2 = require("os");
    var util = require_util();
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/cpu.js
var require_cpu = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/cpu.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var exec = require("child_process").exec;
    var execSync2 = require("child_process").execSync;
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/memory.js
var require_memory = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/memory.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var exec = require("child_process").exec;
    var execSync2 = require("child_process").execSync;
    ...
    function mem(callback) {
      return new Promise((resolve) => {
        process.nextTick(() => {
          ...
          if (_linux) {
            try {
              fs2.readFile("/proc/meminfo", (error, stdout) => {
                if (!error) {
                  const lines = stdout.toString().split("\n");
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/battery.js
var require_battery = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/battery.js"(exports2, module2) {
    "use strict";
    var exec = require("child_process").exec;
    var fs2 = require("fs");
    var util = require_util();
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/graphics.js
var require_graphics = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/graphics.js"(exports2) {
    "use strict";
    var fs2 = require("fs");
    var path2 = require("path");
    var exec = require("child_process").exec;
    ...
    function graphics(callback) {
      ...
      function getNvidiaSmi() {
        ...
        if (_windows) {
          try {
            const basePath = path2.join(util.WINDIR, "System32", "DriverStore", "FileRepository");
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/filesystem.js
var require_filesystem = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/filesystem.js"(exports2) {
    "use strict";
    var util = require_util();
    var fs2 = require("fs");
    var os2 = require("os");
...
${BSDName}|"; smartctl -H ${BSDName} | grep overall;`;
          ...
          if (_darwin) {
            let cmdFullSmart = "";
            exec(`system_profiler SPSerialATADataType SPNVMeDataType ${parseInt(os2.release(), 10) > 24 ? "SPUSBHostDataType" : "SPUSBDataType"} `, { maxBuffer: 1024 * 1024 }, (error, stdout) => {
              if (!error) {
                const lines = stdout.toString().split("\n");
                const linesSATA = [];
                const linesNVMe = [];
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/network.js
var require_network = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/network.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var exec = require("child_process").exec;
    var execSync2 = require("child_process").execSync;
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/wifi.js
var require_wifi = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/wifi.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var exec = require("child_process").exec;
    var execSync2 = require("child_process").execSync;
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/processes.js
var require_processes = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/processes.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var fs2 = require("fs");
    var path2 = require("path");
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/users.js
var require_users = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/users.js"(exports2) {
    "use strict";
    var exec = require("child_process").exec;
    var util = require_util();
    var _platform = process.platform;
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/internet.js
var require_internet = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/internet.js"(exports2) {
    "use strict";
    var util = require_util();
    var _platform = process.platform;
    var _linux = _platform === "linux" || _platform === "android";
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/dockerSocket.js
var require_dockerSocket = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/dockerSocket.js"(exports2, module2) {
    "use strict";
    var net = require("net");
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/docker.js
var require_docker = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/docker.js"(exports2) {
    "use strict";
    var util = require_util();
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/virtualbox.js
var require_virtualbox = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/virtualbox.js"(exports2) {
    "use strict";
    var os2 = require("os");
    var exec = require("child_process").exec;
    var util = require_util();
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/printer.js
var require_printer = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/printer.js"(exports2) {
    "use strict";
    var exec = require("child_process").exec;
    var util = require_util();
    var _platform = process.platform;
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/usb.js
var require_usb = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/usb.js"(exports2) {
    "use strict";
    var exec = require("child_process").exec;
    var util = require_util();
    var _platform = process.platform;
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/audio.js
var require_audio = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/audio.js"(exports2) {
    "use strict";
    var exec = require("child_process").exec;
    var execSync2 = require("child_process").execSync;
    var util = require_util();
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/bluetoothVendors.js
var require_bluetoothVendors = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/bluetoothVendors.js"(exports2, module2) {
    "use strict";
    module2.exports = {
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/bluetooth.js
var require_bluetooth = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/bluetooth.js"(exports2) {
    "use strict";
    var exec = require("child_process").exec;
    var execSync2 = require("child_process").execSync;
    var path2 = require("path");
...
// ../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/index.js
var require_lib = __commonJS({
  "../../node_modules/.pnpm/systeminformation@5.31.7/node_modules/systeminformation/lib/index.js"(exports2) {
    "use strict";
...
// electron/main.cjs
var { app, BrowserWindow, ipcMain, nativeTheme, Tray, Menu, MenuItem } = require("electron");
...
function toImpact(cpu, memMb) {
  return cpu > 5 || memMb > 600 ? "High" : cpu > 1 || memMb > 200 ? "Medium" : "Low";
}
ipcMain.handle("system:metrics", async () => {
  ...
  const data = {
    ...
    allGpus,
    ram: { used: mem.active, total: mem.total, available: mem.available }
  };
...
ipcMain.handle("system:drivers", async () => {
  ...
  try {
    ...
    if (gpu) {
      ...
      drivers.push({
        id: "gpu",
        name: `${gpu.vendor || ""} ${gpu.name || "Graphics"}`,
        ...
        driverDate: (/* @__PURE__ */ new Date()).toISOString().split("T")[0]
      });
    }
    try {
      ...
      if (audio && audio.length > 0) {
        const a = audio[0];
        drivers.push({ id: "audio", name: a.name || "Audio Controller", vendor: a.vendor || "Realtek", version: a.driverVersion || "N/A", status: "Up to date", type: "Audio", updateAvailable: false, driverDate: (/* @__PURE__ */ new Date()).toISOString().split("T")[0] });
      }
    } catch (_) {
    }
    try {
      ...
      if (net && net.length > 0) {
        const n = net[0];
        drivers.push({ id: "network", name: n.name || "Network Adapter", vendor: n.manufacturer || "Intel", version: n.driverVersion || "N/A", status: "Latest", type: "Network", updateAvailable: false, driverDate: (/* @__PURE__ */ new Date()).toISOString().split("T")[0] });
      }
    } catch (_) {
    }
    const bios = await si.bios();
    drivers.push({ id: "bios", name: `BIOS/UEFI ${bios.vendor || ""} ${bios.version || ""}`, vendor: bios.vendor || "Unknown", version: bios.version || "N/A", status: "Latest", type: "BIOS", updateAvailable: false, driverDate: bios.releaseDate || (/* @__PURE__ */ new Date()).toISOString().split("T")[0] });
    const bb = await si.baseboard();
    drivers.push({ id: "chipset", name: `Chipset ${bb.manufacturer || ""} ${bb.model || ""}`, vendor: bb.manufacturer || "Unknown", version: bb.version || "N/A", status: "Up to date", type: "Chipset", updateAvailable: false, driverDate: (/* @__PURE__ */ new Date()).toISOString().split("T")[0] });
    try {
      const usb = await si.usb();
      if (usb && usb.length > 0) {
        drivers.push({ id: "usb", name: "USB Controller", vendor: usb[0].vendor?.name || "Intel", version: usb[0].driverVersion || "N/A", status: "Latest", type: "USB", updateAvailable: false, driverDate: (/* @__PURE__ */ new Date()).toISOString().split("T")[0] });
      }
    } catch (_) {
    }
  } catch (_) {
...
ipcMain.handle("system:scanGames", async () => {
  const gameDirs = /* @__PURE__ */ new Set(), scannedNames = /* @__PURE__ */ new Set(), gameProfiles = [];
  const paths = [
  ...
  for (let d = 68; d <= 90; d++) {
    ...
    try {
      if (fs.existsSync(dr + "\\")) {
        ["\\Program Files\\Steam\\steamapps\\common", "\\Program Files (x86)\\Steam\\steamapps\\common", "\\Program Files\\Epic Games"].forEach((p) => {
          if (fs.existsSync(dr + p)) gameDirs.add(dr + p);
        });
      }
    } catch (_) {
    }
  ...
  for (const dir of gameDirs) {
    try {
      ...
      for (const item of fs.readdirSync(dir)) {
        ...
        try {
          if (fs.statSync(ip).isDirectory()) {
            ...
            valid = !!files.find((f) => {
              ...
              return lf.endsWith(".exe") && !["unins", "setup", "redist", "vc_redist", "directx", "launcher"].some((x) => lf.includes(x));
            });
            files.filter((f) => {
              const lf = f.toLowerCase();
              return lf.endsWith(".pak") || lf.endsWith(".exe") || lf.endsWith(".utoc") || lf.endsWith(".ucas");
            }).slice(0, 15).forEach((bf) => {
              try {
                sz += fs.statSync(path.join(ip, bf)).size;
              } catch (_) {
              }
            });
        ...
        if (valid) {
          scannedNames.add(li);
          gameProfiles.push({ id: "g" + Date.now() + "_" + gameProfiles.length, name: item, preset: "Balanced", fpsTarget: 60, size: Math.max(Math.round(sz / 1073741824 * 10) / 10 || 1, 1), path: ip });
        }
      }
    } catch (_) {
    }
...
var CLEANUP_SAGE_REG_PATH = "HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\VolumeCaches";
...
ipcMain.handle("system:cleanup", async () => {
  ...
  let totalFreed = 0;
  try {
    execSync('powershell -Command "cleanmgr /sagerun:11"', { windowsHide: true, timeout: 12e4 });
  ...
  try {
    const dismOut = execSync("Dism.exe /Online /Cleanup-Image /AnalyzeComponentStore", { encoding: "utf8", windowsHide: true, timeout: 12e4 });
    if (dismOut.includes("Component Store can be cleaned up")) {
      execSync("Dism.exe /Online /Cleanup-Image /StartComponentCleanup /ResetBase", { windowsHide: true, timeout: 3e5 });
  ...
  const tempDirs = [
    ...
    process.env.LOCALAPPDATA + "NVIDIADXCache",
    process.env.LOCALAPPDATA + "NVIDIAGLCache",
    process.env.LOCALAPPDATA + "AMDCache"
  ].filter(Boolean);
    ...
    try {
      ...
      for (const file of files) {
        try {
          ...
          if (stat.isFile() && Date.now() - stat.mtimeMs > 864e5) {
            freed += stat.size;
            fs.unlinkSync(fp);
            cleaned++;
          }
    ...
    if (fs.existsSync(pf)) {
      ...
      for (const file of fs.readdirSync(pf).slice(0, 200)) {
        try {
          ...
          if (stat.isFile() && Date.now() - stat.mtimeMs > 6048e5) {
            freed += stat.size;
            fs.unlinkSync(fp);
            cleaned++;
          }
...
ipcMain.handle("system:cmd:optimize:apply", async (_event, payload) => {
  ...
  try {
    if (id === "o1") {
      execSync("powercfg /setactive 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c 2>nul", { windowsHide: true });
      results.push("Game Mode enabled");
    }
    if (id === "o2") {
      execSync("powercfg /setactive e9a42b02-d5df-448d-aa00-03f14749eb61 2>nul", { windowsHide: true });
      results.push("High Performance power plan activated");
    }
    if (id === "o4") {
      execSync('taskkill /f /im "Discord.exe" 2>nul & taskkill /f /im "chrome.exe" 2>nul & taskkill /f /im "firefox.exe" 2>nul', { windowsHide: true });
      results.push("Background tasks terminated");
    }
    if (id === "o5") {
      const r = await ipcMain.emit("system:cleanup");
      results.push(`Cleaned ${r.totalFreedGb || 0} GB`);
    }
    if (id === "o8") {
      try {
    ...
    results.push("Partially applied");
  }
  return { ok: true, results, timestamp: (/* @__PURE__ */ new Date()).toLocaleTimeString() };
});
...
ipcMain.handle("system:cmd:drivers:update", async (_event, payload) => {
  const results = [];
  try {
    const updateCheck = execSync('powershell -Command "Get-WindowsUpdate -IsDriversOnly -ErrorAction SilentlyContinue | Select-Object Title, DriverModel, InstalledOn"', { encoding: "utf8", windowsHide: true, timeout: 1e4 });
    ...
    if (tempDir && fs.existsSync(tempDir)) {
      ...
      try {
        ...
        for (const f of files) {
          try {
            tempSize += fs.statSync(path.join(tempDir, f)).size;
          } catch (_) {
          }
        }
...
var gameWatchlist = /* @__PURE__ */ new Map();
...
ipcMain.handle("system:benchmarks:save", async (_event, payload) => {
  if (payload && payload.results) {
    benchmarkHistory.push({ ...payload, timestamp: (/* @__PURE__ */ new Date()).toISOString() });
    if (benchmarkHistory.length > 100) benchmarkHistory.shift();
  }
  return { ok: true, count: benchmarkHistory.length };
});
var performanceHistory = [];
var MAX_PERF_HISTORY = 500;
var networkPrevStats = null;
var sessionNetworkTotal = { rx: 0, tx: 0 };
var NETWORK_TTL = 2e3;
async function getNetworkStats() {
  try {
    ...
    const activeInterface = interfaces.find(
      (iface) => iface.operstate === "up" && iface.ipaddress && !iface.ipaddress.startsWith("127.")
    ) || interfaces[0];
